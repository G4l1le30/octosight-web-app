        ...
        "articles": [
            {
                ...
                "description": "An in-depth explanation of whaling attacks targeting executives. Covers statistics, attack frameworks, and defense strategies."
            }
        ]
    },
    {
        ...
        "articles": [
            {
                ...
                "description": "An in-depth explanation of the zero-day lifecycle, detection challenges, and layered defense strategies using NGAV, EDR, and network segmentation."
            }
        ]
    },
    {
        ...
        "articles": [
            {
                ...
                "description": "A checklist with best practices from the FBI and SANS Institute. Covers detection, containment, analysis, remediation, and recovery phases."
            }
        ]
    },
    {
        ...
        "articles": [
            {
                ...
                "description": "An advanced CTI-based approach to zero-day hunting. Covers threat intelligence collection, analysis, EDR systems, and response procedures with real-world scenarios."
            }
        ]
    }
]
