      ...
      <div className="max-w-md w-full">
        <div className="card p-10 shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-secondary-light text-sm mt-1">Sign in to your OctoSight account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              <label htmlFor="login-email" className="text-xs font-bold text-secondary/60">Email Address</label>
              <input
                id="login-email"
                type="email"
            ...
            <div className="space-y-1.5">
              <label htmlFor="login-password" className="text-xs font-bold text-secondary/60">Password</label>
