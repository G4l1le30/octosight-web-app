      ...
      <div className="relative z-10">
        {isCompleted ? (
          <>
            ...
            <h3 className="text-xl md:text-2xl font-bold text-green-800 mb-2">Module Completed!</h3>
            ...
            <div className="flex justify-center gap-3 md:gap-4">
              <Button 
                onClick={onStartQuiz}
                className="bg-green-600 hover:bg-green-700 text-white gap-2 px-6 md:px-8 py-4 md:py-5 text-base md:text-lg"
              >
              ...
              {onNextModule && (
                <Button 
                  ...
                  variant="outline"
                  className="bg-white border-neutral-border text-secondary hover:border-green-500 gap-2 px-6 md:px-8 py-4 md:py-5 text-base md:text-lg shadow-sm transition-colors"
                >
          ...
          <>
            <h3 className="text-xl md:text-2xl font-bold text-secondary mb-2">Module Locked</h3>
            ...
            <Button disabled className="gap-2 px-6 md:px-8 py-4 md:py-6 text-base md:text-lg bg-neutral-border text-secondary/40 border-none pointer-events-none shadow-none">
              <Lock className="size-5" /> Quiz Locked
            </Button>
          </>
        ) : !allMaterialsFinished ? (
          <>
            <h3 className="text-xl md:text-2xl font-bold text-secondary mb-2">Quiz Locked</h3>
            <p className="text-secondary-light font-medium mb-4 md:mb-6 max-w-lg mx-auto">
          ...
          <>
            <h3 className="text-xl md:text-2xl font-bold text-secondary mb-2">Test Your Knowledge</h3>
            <p className="text-secondary-light font-medium mb-4 md:mb-6 max-w-lg mx-auto">
              {savedQuiz 
            ...
            <div className="flex flex-col items-center gap-3 md:gap-4">
              <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                <Button 
                  onClick={onStartQuiz}
                  className="gap-2 px-8 md:px-10 py-5 md:py-7 text-xl shadow-lg shadow-black/10"
                >
                ...
                {savedQuiz && onResetQuiz && (
                  <Button 
                    onClick={onResetQuiz}
                    variant="outline"
                    className="gap-2 px-6 md:px-8 py-5 md:py-7 text-base md:text-lg border-risk-high/30 text-risk-high hover:bg-risk-high/5"
                  >
                    Start Fresh
                  </Button>
                )}
