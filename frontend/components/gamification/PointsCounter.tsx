  ...
  return (
    <div className="bg-white border border-neutral-border rounded-xl p-6">
      <div className="flex items-center justify-between mb-3">
        <div>
          <p className="text-base font-semibold text-secondary">Total Points</p>
          <p className="text-3xl font-bold text-secondary">{points}</p>
        </div>
        <div className="text-right">
          <p className="text-base font-semibold text-secondary">Level</p>
          <p className="text-3xl font-bold text-primary">{level}</p>
        </div>
      </div>
      <div className="w-full rounded-full bg-neutral-border h-2 overflow-hidden">
