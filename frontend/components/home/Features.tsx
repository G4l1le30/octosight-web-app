  ...
  const features = [
    {
      ...
      description: "Easily submit suspicious URLs or messages via our streamlined portal.",
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "AI-driven analysis combined with rule-based heuristics for maximum coverage.",
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Automated prioritization of high-risk cases to minimize potential damage.",
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: "Targeted Edu",
      description: "Microlearning modules triggered by high-risk activities to improve digital literacy.",
    },
  ];
