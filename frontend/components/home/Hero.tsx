  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-neutral-page/30 to-white min-h-[calc(100vh-64px)] flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 text-center max-w-6xl py-20 relative z-10">
        ...
        <p className="text-lg md:text-xl text-secondary/80 mb-16 max-w-3xl mx-auto font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300">
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-5 justify-center mb-16 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500">
          <Link
            href="/report"
