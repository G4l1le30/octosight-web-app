...
export const SectionCtaBannerSubsection = () => {
  return (
    <section className="w-full bg-white px-3 py-12 md:px-4 md:py-16">
      <Card className="relative mx-auto flex w-full max-w-screen-xl overflow-hidden rounded-[30px] md:rounded-[40px] border-0 bg-[#e11d2e] shadow-[0px_25px_50px_-12px_#00000040]">
        ...
        <CardContent className="relative flex w-full flex-col items-center gap-4 md:gap-6 px-4 py-9 md:px-10 md:py-16 lg:px-20 lg:py-20">
          <header className="flex w-full justify-center">
            <h2 className="text-center text-2xl leading-snug text-white md:text-4xl lg:text-5xl lg:leading-[48px] font-bold">
              {ctaContent.title}
            </h2>
          </header>
          <div className="flex w-full max-w-2xl justify-center pb-4 md:pb-6">
            <p className="text-center text-base leading-6 md:text-lg md:leading-7 text-red-100 font-normal">
          ...
          <Link href="/register">
            <Button
              type="button"
              className="h-auto rounded-full bg-white px-8 py-3.5 text-base md:px-10 md:py-5 md:text-lg leading-7 text-[#e11d2e] shadow-[0px_8px_10px_-6px_#0000001a,0px_20px_25px_-5px_#0000001a] hover:bg-white/95 font-bold"
            >
