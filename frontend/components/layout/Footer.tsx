...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-primary via-primary-dark to-primary-light text-white pt-12 sm:pt-16 lg:pt-20 pb-6 sm:pb-8 lg:pb-10 px-4 sm:px-6 lg:px-8 mt-auto overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1 text-center sm:text-left">
            <p className="text-white text-base md:text-lg leading-relaxed max-w-md mx-auto sm:mx-0 font-medium">
          ...
          <div className="text-center sm:text-left">
            ...
            {!isAdminRoute ? (
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link href="/" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/report" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                    Report Incident
                  </Link>
                </li>
                <li>
                  <Link href="/check" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                    Fraud Check
                  </Link>
                </li>
                <li>
                  <Link href="/status" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                    Check Status
                  </Link>
                </li>
                <li>
                  <Link href="/edu" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                    E-Learning
                  </Link>
                </li>
              </ul>
              ...
              <ul className="space-y-2 sm:space-y-3">
                {can("dashboard.view") && (
                  <li>
                    <Link href="/admin" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                      Dashboard
                    </Link>
                  </li>
                )}
                {can("tickets.view") && (
                  <li>
                    <Link href="/admin/triage" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                      Triage
                    </Link>
                  </li>
                )}
                {can("blacklist.view") && (
                  <li>
                    <Link href="/admin/blacklist" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                      Blacklist
                    </Link>
                  </li>
                )}
                {can("dashboard.view") && (
                  <li>
                    <Link href="/admin/rule-config" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                      Rules
                    </Link>
                  </li>
                )}
                {can("transactions.view") && (
                  <li>
                    <Link href="/admin/transactions" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                      Transactions
                    </Link>
                  </li>
                )}
                {can("users.view") && (
                  <li>
                    <Link href="/admin/users" className="text-white/80 hover:text-white text-xs sm:text-sm transition-colors font-medium">
                      Users
                    </Link>
                  </li>
                )}
