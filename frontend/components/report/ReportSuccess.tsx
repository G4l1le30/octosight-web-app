  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 md:py-8 px-4 sm:px-6 md:px-8 animate-in fade-in zoom-in duration-500">
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl md:rounded-3xl shadow-xl border border-neutral-border flex flex-col items-center p-8 sm:p-10 md:p-12 relative overflow-hidden">
        ...
        <div className="w-full border-2 border-neutral-border rounded-2xl md:rounded-3xl p-6 md:p-8 mb-8 md:mb-10 relative group">
          <p className="text-md font-bold text-secondary mb-3 md:mb-4 text-center">
            Ticket Reference
          </p>
          <div className="relative flex flex-col items-center">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-4 w-full">
              ...
              <div className="flex items-center justify-center gap-2 md:gap-3">
                ...
                <button
                  onClick={handleCopy}
                  className="p-2 md:p-2.5 bg-white hover:bg-neutral-page border border-neutral-border rounded-lg md:rounded-xl transition-all group/copy cursor-pointer shrink-0 shadow-sm"
            ...
            >
              <span className="text-green-600 text-xs font-bold flex items-center gap-1.5 md:gap-2 bg-green-50 px-3 md:px-4 py-1.5 md:py-2 rounded-full whitespace-nowrap shadow-sm border border-green-200">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-10">
          <div className="flex items-center gap-1.5 md:gap-2 text-secondary/60 font-semibold text-xs md:text-sm">
