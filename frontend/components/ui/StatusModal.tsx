...
export const StatusModal: React.FC<StatusModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 md:p-4 bg-secondary/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full p-6 md:p-8 border border-neutral-border animate-in zoom-in-95 duration-300">
        <div className="text-center">
          <div className={cn(
            "w-8 h-8 md:w-12 md:h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-6",
          ...
          <p className="text-secondary/60 text-sm font-medium leading-relaxed mb-6 md:mb-8">
            {message}
          </p>
